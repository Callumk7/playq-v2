...
// Core Schema. We extend this schema based on the data that we are fetching
...
export const IGDBGameSchema = z.object({
    id: z.number(),
    age_ratings: z.array(z.string()).optional(), // Array of Age Rating IDs
    ...
    alternative_names: z.array(z.string()).optional(), // Alternative Name IDs
    artworks: z.array(artworkType).optional(), // Artworks of this game
    bundles: z.array(z.number()).optional(), // Array of Game IDs
    cover: coverType.optional(), // The cover of this game
    created_at: z.date().optional(), // Date this was initially added
    ...
    external_games: z.array(externalGamesType).optional(), // External Game IDs
    first_release_date: z.number().optional(), // Unix Time Stamp
    ...
    game_status: z.enum(gameStatusEnumValues).optional(), // Game Status
    game_type: z.enum(gameTypeEnumValues).optional(), // Game Type
    genres: z.array(genreType).optional(), // Genres of the game
    ...
    keywords: z.array(z.string()).optional(), // Associated keywords
    ...
    screenshots: z.array(screenshotType).optional(), // Screenshots of this game
    ...
    updated_at: z.date().optional(), // Last date updated
...
// Omit artwork fields for the no artwork schema
